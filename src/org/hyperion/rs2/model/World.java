...
import org.hyperion.rs2.event.impl.AutoSaveEvent;
...
import org.hyperion.rs2.event.impl.RestoreEvent;
...
public class World {
	...
	private void registerGlobalEvents() {
		...
		submit(new AutoSaveEvent());
		submit(new WorldObjectRemovalEvent());
	}
		...
		engine.submitWork(new Runnable() {
			public void run() {
				...
				if(!Constants.CONNNECT_TO_LOGIN_SERVER)
					...
					if(isPlayerOnline(lr.getPlayer().getNameAsLong()))
						code = 5;
