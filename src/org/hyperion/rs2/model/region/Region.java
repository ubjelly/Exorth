...
public class Region {
	 ...
	 */
	private List<FloorItem> floorItems = new LinkedList<FloorItem>();
	 ...
	 * @return The list of players.
	 */
	public Collection<FloorItem> getRegionItems() {
		synchronized(this) {
			return Collections.unmodifiableCollection(new LinkedList<FloorItem>(floorItems));
		}
	}
	
	/**
	 * Adds a FloorItem to the regions array.
	 * @param i The floorIte.
	 * @return
	 */
	public void addFloorItem(FloorItem i) {
		synchronized(this) {
			floorItems.add(i);
		}
	}
	...
	/**
	 * Removes a FloorItem to the regions array.
	 * @param i The floorIte.
	 * @eturn
	 */
