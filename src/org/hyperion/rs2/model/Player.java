...
public class Player extends Entity implements Persistable {
	...
	public void applyHealthChange(int amount, boolean limit) {
		...
		if(Constants.CONSTITUTION_ENABLE) {//If Constitution is anabled.
			...
			int set = finalhp > skills.getMaxHealthLevel() && limit ? skills.getMaxHealthLevel() : finalhp;
	...
	public int determineNextCombatAttack(Entity Opp) {
		// TODO Auto-generated method stub
		return !this.getMagicSpells().isEmpty()? 2 : WeaponStyle.getType(this) != WeaponStyle.TYPE_RANGED ? 0 : 1;//Melee
	}
	...
	/**
	 * @param specialAmount the specialAmount to set
	 */
	public void setSpecialAmount(byte specialAmount) {
		if(specialAmount > 99) specialAmount = 100;
